...
SWIGEXPORT jboolean JNICALL Java_com_mapzen_tangram_TangramJNI_addDataSource(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jboolean jresult = 0 ;
  ...
  if (argp1) arg1 = *argp1;
  result = (bool)Tangram::addDataSource(arg1);
  jresult = (jboolean)result;
  return jresult;
}


SWIGEXPORT jboolean JNICALL Java_com_mapzen_tangram_TangramJNI_removeDataSource(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jboolean jresult = 0 ;
  ...
  result = (bool)Tangram::removeDataSource(*arg1);
  jresult = (jboolean)result;
  return jresult;
}
