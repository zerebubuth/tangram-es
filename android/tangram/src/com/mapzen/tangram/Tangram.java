...
public class Tangram {
    public static boolean addDataSource(DataSource _source) {
        return TangramJNI.addDataSource(DataSource.getCPtr(_source), _source);
    }

    public static boolean removeDataSource(DataSource _source) {
        return TangramJNI.removeDataSource(DataSource.getCPtr(_source), _source);
    }
